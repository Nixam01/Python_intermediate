...
dir = 'C:/Users/marci/PycharmProjects/Python_sredniozaawansowany/data/url/'
file = 'spis.html'
...
file = 'logo.png'
save_url_file(url, dir, file, msg)
directory = r'C:\Users\marci\PycharmProjects\Python_sredniozaawansowany\data\url'
save_url_to_dir = functools.partial(save_url_file, dir=directory, msg = 'Please wait: {}')
url = 'http://mobilo24.eu/spis'
file = 'spis.html'
